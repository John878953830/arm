...
uint8_t disableActuator(uint8_t id)
{
	...
	/* 若当前已经处于目标状态，直接返回成功 */
	if (pSCA->Power_State == Actr_Disable)
		return SCA_NoError;
